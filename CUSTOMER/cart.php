...
<!-- delete account popup modal end-->
      ...
      <div class="col-lg-8">
        ...
        <div class="widget dashboard-container my-adslist">
          <h3 class="widget-header">Cart Details</h3>
                  ...
                  <div class="">
                    <ul class="list-inline justify-content-center">
                      ...
                      <li class="list-inline-item">
                        <a class="delete" data-toggle="tooltip" data-placement="top" title="Delete" href="delete_cart.php?cartid=<?php echo $cart_result->cart_id; ?>">
          ...
          <ul class="list-inline mt-20">
              ...
              <li class="list-inline-item">
                ...
                <a href="payment.php?cartid=<?php echo $cart_result->cart_id; ?>" class="btn btn-offer d-inline-block btn-primary ml-n1 my-1 px-lg-4 px-md-3">Place Order</a>
