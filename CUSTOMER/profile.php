...
$customer = $con->query("select * from customer where customer_id='$id'");
...
if(isset($_POST["submit"]))
{
	...
	$result = $con->query("update customer set name='$name',contact='$contact',address='$address',pincode='$pincode',city_id='$city2',area_id='$area2' where customer_id='$id' ");
	if($result)
	{
...
if(isset($_POST["update"]))
{
	...
	if($email==$raw->email)
	{
		$change = $con->query("update customer set email='$nemail' where customer_id='$id'");
		if($change)
		{
