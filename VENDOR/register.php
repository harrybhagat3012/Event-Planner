...
if(isset($_POST["submit"]))
{
  ...
  $user = $con->query("select * from worker where email='$email' & password='$pass'");
  ...
  if($rowcount == 0)
  {
    if($pass == $cpass)
    {
      ...
      $exe = $con->query("insert into worker(name,email,contact,address,pincode,city_id,area_id,cat_id,experiance,date,password) values('$name','$email','$contact','$address','$pincode','$city2','$area2','$cat','$experiance','$date','$pass')");
...
$service = $con->query("select * from service");
?>
<!DOCTYPE html>
<html lang="en">
                        ...
                        <fieldset class="p-4">
                            <div class="form-group">
                                ...
                                <div class="row">
                                  ...
                                  <div class="col-lg-6 py-2">
                                     <select class="form-control mb-3" id="service" name="service">
                                       <option value="">--select service--</option>
                                       <?php
                                         while($ser=$service->fetch_object())
                                         {
                                       ?>
                                       <option value="<?php echo $ser->cat_id; ?>"><?php echo "$ser->cat_name";?></option>
                                        <?php
                                          }
                                        ?>
                                    </select>
                                ...
                                <div class="row">
                                  <div class="col-lg-6 py-2">
                                    <input class="form-control mb-3" type="text" id="experiance" name="experiance" placeholder="experiance" required>
                                  </div>
                                  <div class="col-lg-6 py-2">
                                    <input class="form-control mb-3" type="date" id="date" name="date"  required>
                                  </div>
                                </div>
                                 <div class="row">
                                  <div class="col-lg-6 py-2">
