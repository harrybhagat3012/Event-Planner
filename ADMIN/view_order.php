...
$category = $con->query("select * from order_info");
					...
					<div class="panel-body widget-shadow">
						...
						<table class="table">
							...
							<?php
								...
								{
									$service = $con->query("select * from post_info where event_id='$row->event_id'");
									$service1 = $service->fetch_object();
